...
def draw_fov(raw_file, fov_list, color, target_file):
    ...
    print(arr.shape)
    midpoint = (int(arr.shape[0]/10./2), int(arr.shape[1]/2))
    print(midpoint)
    for fov in fov_list:
        fov_offset = (int(fov[0]/2), int(fov[1]/2.))
    ...
    #print("lower",10*(midpoint[0]-fov_offset[0]), midpoint[1]-fov_offset[1],midpoint[1]+fov_offset[1]+1)
        arr[10*(midpoint[0]-fov_offset[0]), midpoint[1]-fov_offset[1]:midpoint[1]+fov_offset[1]+1,:] = color
    #print("upper",10 * (midpoint[0] + fov_offset[0]+1)-1, midpoint[1] - fov_offset[1],midpoint[1] + fov_offset[1] + 1)
        arr[10 * (midpoint[0] + fov_offset[0]+1)-1, midpoint[1] - fov_offset[1]:midpoint[1] + fov_offset[1] + 1, :] = color
    #print("left",10*(midpoint[0]-fov_offset[0]),10*(midpoint[0]+fov_offset[0]+1), midpoint[1]-fov_offset[1])
        arr[10*(midpoint[0]-fov_offset[0]):10*(midpoint[0]+fov_offset[0]+1), midpoint[1]-fov_offset[1],:] = color
...
if __name__ == '__main__':
    ...
    list_of_fovs = [(3, 3), (5, 5), (7, 11), (9, 17), (11, 35), (13, 53), (15, 107), (17, 161), (19, 179), (21, 197),
                    (23, 203), (25, 209), (27, 211), (29, 213)]
