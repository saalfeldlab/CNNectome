...
def make_inference_mask(output_shape, output_file, mask_file):
    ...
    pred_mask_shape = [sfull // outs + 1 for sfull, outs in zip(shape_full, output_shape)]
...
if __name__=='__main__':
    ...
    output_file = '/nrs/saalfeld/heinrichl/synapses/sampleE_DTU2_offsets/block_list_in_mask.json'
