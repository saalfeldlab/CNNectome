...
class ExpResult:
    ...
    def get_all_it_cs(self, mode='validation', json_name='validation', sample=('A', 'B', 'C')):
    ...
    def get_all_it_gcs(self, mode='validation', json_name='validation', sample=('A', 'B', 'C')):
        if isinstance(sample, str):
            sample = (sample, )
        res = []
        for it in self.all_iterations:
    ...
    def get_all_it_adgt(self, mode='validation', json_name='validation', sample=('A', 'B', 'C')):
        if isinstance(sample, str):
            sample = (sample, )
        res = []
        for it in self.all_iterations:
    ...
    def get_all_it_adf(self, mode='validation', json_name='validation', sample=('A', 'B', 'C')):
        if isinstance(sample, str):
            sample = (sample, )
        res = []
        for it in self.all_iterations:
