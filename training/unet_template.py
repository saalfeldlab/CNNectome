...
data_sources.append(
    N5Dataset(
        "crop6", 250 * 250 * 250, special_categories=("ribosomes",), data_dir=data_dir
    )
)
data_sources.append(
    N5Dataset(
        "crop7", 300 * 300 * 80, special_categories=("ribosomes",), data_dir=data_dir
    )
)
...
data_sources.append(
    N5Dataset(
        "crop13", 160 * 160 * 110, special_categories=("ribosomes",), data_dir=data_dir
    )
)
...
labels.append(
    Label(
        "chromatin", (24, 25, 26, 27, 36), data_sources=data_sources, data_dir=data_dir
    )
)
