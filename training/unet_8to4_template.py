...
from networks.isotropic.mk_dtu_cell_8to4 import make_net
from networks import unet_class
from training.isotropic.train_cell_8to4 import train_until
import json
import numpy as np
...
def build_net(steps=steps_inference, mode='inference'):
    unet = unet_class.UNet([12, 12*6, 12*6**2, 12*6**3],
                           ...
                           [[(3, 3, 3), (3, 3, 3)], [(3, 3, 3), (3, 3, 3)],
                            [(3, 3, 3), (3, 3, 3)]],
                           input_voxel_size=(8, 8, 8), input_fov=(8, 8, 8))
