...
def train_until(max_iteration, data_sources, input_shape, output_shape, augmentor, snapshotname):
    ArrayKey('RAW')
    ArrayKey('GT_LABELS')
    ArrayKey('GT_MASK')
    ...
    train_pipeline = (train_pipeline+                  ElasticAugment((4,40,40),(0.,0.,0.), (0,0),
    ...
    train_pipeline = (train_pipeline +Snapshot({
                ArrayKeys.RAW:                   'volumes/raw',
            },
            every=1,
...
if __name__ == "__main__":
    ...
    for augmentor, snapshotname in zip(augmentors, names):
        train_until(max_iteration, data_sources, input_shape, output_shape, augmentor, snapshotname)
