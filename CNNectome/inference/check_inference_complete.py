...
def get_output_paths(raw_data_path: str,
                     setup_path: str,
                     output_path: str,
                     iteration: Optional[int] = None) -> Tuple[str, str]:
    """
    ...
    if output_path is None:
        assert iteration is not None, "need iteration to be specified to autogenerate output_path"
...
def main() -> None:
    ...
    _, out_file = get_output_paths(raw_data_path, setup_path, output_path, iteration=iteration)
