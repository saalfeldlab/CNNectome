...
from CNNectome.networks.isotropic.mk_scale_net_cell_generic import make_any_scale_net
from CNNectome.networks import scale_net
from CNNectome.training.isotropic.train_cell_scalenet_generic import train_until
import json
import numpy as np
