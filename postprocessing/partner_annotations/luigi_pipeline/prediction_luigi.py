...
def single_inference(data_train, augmentation, data_eval, samples, gpu, iteration):
    subprocess.call(['/groups/saalfeld/home/heinrichl/Projects/CNNectome/postprocessing/partner_annotations_luigi'
              '/run_inference'
          '.sh', data_train, augmentation, data_eval, samples, gpu, iteration])
...
class Predict(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget(os.path.join(os.path.dirname(self.input().fn), 'pred.msg'))
