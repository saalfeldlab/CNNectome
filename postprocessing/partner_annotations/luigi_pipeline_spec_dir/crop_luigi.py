...
class Crop(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget(os.path.join(os.path.dirname(self.input()[0].fn), self.de, 'crop.msg'))
    ...
    def run(self):
        ...
        for s in self.samples:
            filename = os.path.join(os.path.dirname(self.input()[0].fn), self.de, s + '.n5')
