...
def set_mask_to_zero(filename_src, dataset_src, filename_mask, dataset_mask, filename_tgt, dataset_tgt, offset, shape):
...
def main_seg():
    ...
    for sample in samples:
        ...
        off = offsets[sample]
        sh = shapes[sample]
        set_mask_to_zero(filename_src.format(sample), dataset_src,
                         filename_mask.format(sample), dataset_mask,
                         filename_tgt.format(sample), dataset_tgt,
                         off, sh)
