...
if __name__ == "__main__":
    ...
    raw =tf.placeholder(tf.float32, shape=(22,214,214))#shape=(91, 862, 862))
    raw_batched = tf.reshape(raw, (1,1)+tuple(raw.get_shape().as_list()))#tf.expand_dims(tf.expand_dims(raw, 0),0)
