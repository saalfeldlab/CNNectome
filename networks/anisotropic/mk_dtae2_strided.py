from networks import strided_autoencoder
...
def train_net():
    ...
    last_fmap, fov, anisotropy = strided_autoencoder.strided_autoencoder(raw_batched, 12, 6, [[1, 3, 3], [1, 3, 3], [3, 3, 3]],
    ...
    dist_batched, fov = strided_autoencoder.conv_pass(
            last_fmap,
            kernel_size=[[1, 1, 1]],
            num_fmaps=1,
            activation=None,
