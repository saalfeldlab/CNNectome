...
def make_net(unet, added_steps, loss_name='loss_total', mode='train'):
    ...
    if mode.lower() == 'train' or mode.lower() == 'training':
        ...
        loss_unbalanced_cleft = tf.losses.mean_squared_error(gt_cleft_dist, cleft_dist, cleft_mask)
        loss_unbalanced_pre = tf.losses.mean_squared_error(gt_pre_dist, pre_dist, pre_mask)
        loss_unbalanced_post = tf.losses.mean_squared_error(gt_post_dist, post_dist, post_mask)
        ...
        loss_total_unbalanced = loss_unbalanced_cleft + loss_unbalanced_pre + loss_unbalanced_post
