...
if __name__ == "__main__":
    ...
    unet, fov, anisotropy = networks.unet(raw_batched, 12, 6, [[1, 3, 3], [1, 3, 3], [3, 3, 3]],
                                                    [[(1,3,3),(1,3,3)], [(1,3,3),(1,3,3)],[(3,3,3),(3,3,3)],[(3,
                                                                                                                  3,3),
                                                                                                            (3,3,3)]],

                                                    [[(1, 3, 3), (1, 3, 3)], [(1, 3, 3), (1, 3, 3)], [(3, 3,
                                                                                                                3),
                                                                                                           (3,
                                                                                                                  3, 3)],
                                                    [(3, 3, 3),(3, 3, 3)]],
                                                   anisotropy=[10,1,1], fov=[10,1,1])
