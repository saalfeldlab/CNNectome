...
def train_net(labels):
    ...
    last_fmap8, fov, anisotropy = unet.unet(raw_bc, [12, 12*6, 12*6*6, 12*6*6*6], [48, 12*6, 12*6*6, 12*6*6*6],
                                            [[2, 2, 2], [2, 2, 2], [3, 3, 3]],
    ...
    fmap4, anisotropy = ops3d.upsample(last_fmap8, [2, 2, 2], 48, name='labelSR_up', fov=fov, voxel_size=anisotropy)
    print("final_upsample: " + str(fmap4.shape))
    last_fmap4, fov = ops3d.conv_pass(fmap4, [(3,3,3), (3,3,3)], num_fmaps=48, fov=fov, voxel_size=anisotropy,
                                      name='finalconv')
    print("final convolutions: " + str(last_fmap4.shape))
    ...
    print("final shape: " + str(dist_bc.shape))
...
def inference_net(labels):
    ...
    last_fmap8, fov, anisotropy = unet.unet(raw_bc, [12, 12 * 6, 12 * 6 * 6, 12 * 6 * 6 * 6],
